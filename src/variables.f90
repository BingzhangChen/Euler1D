...
integer, parameter :: N_ESD   = 20  !Number of phytoplankton size classes
...
real, parameter :: dPHYESD = (MaxSPHY - MinSPHY)/dble(NPHY-1) ! ESD difference between adjacent PHYplankton size class (log)
